...
('Suzuki Raider R150 Fi','motorcycle','Suzuki','Underbone legend with fuel injection.',129900.00,true,true,17),
('Suzuki GSX-S150','motorcycle','Suzuki','150cc sporty streetfighter.',119000.00,true,true,18),
('Kawasaki KLX150','motorcycle','Kawasaki','Lightweight trail bike, brand new unit.',159000.00,true,true,19),
