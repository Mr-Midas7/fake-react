-- A moved appointment is a new booking and must follow the normal approval flow.
-- Keep the original record as "rescheduled" for history, but start its replacement as "pending".
